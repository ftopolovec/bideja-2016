<?php while (have_posts()) : the_post(); ?>
  ...
  <div class="container top-marg-50">
    <div class="col-md-5 ukratko">
      <h2>Tko smo i čime se bavimo?</h2>
      <hr align="left">
      ...
      <a href="#" class="hvr-icon-forward">Kontaktirajte nas!</a>
    </div>
    <div class="col-md-7">
      <img src="<?= esc_url(get_template_directory_uri ()); ?>/assets/images/monitor-mobitel-grafika.jpg" class="img-responsive" alt="Monitor-mobitel grafika">
    </div>
  </div>
</div>
