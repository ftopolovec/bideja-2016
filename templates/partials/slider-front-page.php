<div class="container-fluid no-padding">
	...
	<!-- 
		<div class="item" style="background-image: url('<?php echo esc_url(get_template_directory_uri ()); ?>/assets/images/slider/slider-pozadina1.jpg');">
			<div class="container">
				...
				<div class="col-md-5 col-sm-7 col-xs-12 slider-content">
					...
					<a href="<?= esc_url(get_site_url()); ?>/reference" class="hvr-icon-forward">Sve reference</a>
				</div>
			</div>
		</div>
		 END STATIC ITEM -->
	...
	<!-- LOOP ITEMS -->
		<div class="item" style="background-image: url('<?php echo esc_url(the_field("bi_slider_bg")); ?>');">
			<div class="container">
				...
				<div class="col-md-5 col-sm-7 col-xs-12 slider-content">
					...
					<?php endif; ?>
					<a href="<?php echo get_permalink(); ?>" class="hvr-icon-forward">Pogledaj referencu</a>
				</div>
			</div>
		</div>
		<?php endwhile; ?>
